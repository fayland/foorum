...
sub get_comments_by_object : ResultSet {
    my ( $self, $info ) = @_;
...
sub get_children_comments : ResultSet {
...
sub get_all_comments_by_object : ResultSet {
...
sub prepare_comments_for_view : ResultSet {
    my ( $self, @comments ) = @_;
...
sub remove_by_object : ResultSet {
    my ( $self, $object_type, $object_id ) = @_;
...
Foorum::Schema::Comment - Foorum Comment System
