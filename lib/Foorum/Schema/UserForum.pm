...
sub create_user_forum : ResultSet {
    my ( $self, $info ) = @_;
...
sub remove_user_forum : ResultSet {
    my ( $self, $info ) = @_;
...
sub clear_cached_policy : ResultSet {
    my ( $self, $info ) = @_;
...
sub get_forum_moderators : ResultSet {
    my ( $self, $forum_id ) = @_;
