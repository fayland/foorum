...
=head1 Tutorial 2: Dive into Foorum: TheSchwartz

=head2 TheSchwartz introduction

L<http://search.cpan.org/perldoc?TheSchwartz|TheSchwartz>
...
There is a simple L<RULES> that why we use TheSchwartz, put heavy code on backend script instead of httpd.
...
L<Tutorial1>, L<Tutorial3>, L<Tutorial4>, L<Tutorial5>
