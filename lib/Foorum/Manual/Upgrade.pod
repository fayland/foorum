...
#labels Phase-Deploy
#how to upgrade your Foorum application

=head1 Introduction

It's for upgrade from old version to new Foorum. If u are trying to install from the beginning, try read L<INSTALL>
