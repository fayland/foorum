...
sub _init {
   ...
   my %html_tags   = (
     ...
     flash  => q!<div class='bbcode_flash'><embed src="%s" type="application/x-shockwave-flash"  width="425" height="344"></embed></div>!,
...
controls="ImageWindow,StatusBar,ControlPanel" width='352' height='288' border='0' autostart='flase'></embed></div>!;
       ...
       return $html;
        ...
        if ($content =~ /^http\:\/\/www.youtube.com\/v\//) {
            $html = qq!<div><embed src="$content" type="application/x-shockwave-flash" allowfullscreen="true" width="425" height="344"></embed></div>!;
        }
        return $html;
   } elsif ( $tag eq 'size' ) {
